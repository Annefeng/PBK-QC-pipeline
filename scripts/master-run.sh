...
scr=/data/js95/yfeng/projects/scripts
...
sh $scr/master.sh pop.preimpqc pop.run.batch.assoc eur $wd/eur_preimp_qc $wd/scripts $data $wd/misc/uniq_batch_pairs.tsv
sh $scr/master.sh pop.preimpqc pop.find.batch.assoc eur $wd/eur_preimp_qc $wd/scripts
...
sh $scr/master.sh pop.preimpqc.final pop.write.qc.plink eur $wd/eur_preimp_qc $wd/scripts
sh $scr/master.sh pop.preimpqc.final pop.prep.mis.imp eur $wd/eur_preimp_qc $wd/scripts $wd/misc/HRC-1000G-check-bim-v4.2.7/HRC-1000G-check-bim.pl $wd/misc/HRC.r1-1.GRCh37.wgs.mac5.sites.tab &
sh $scr/master.sh pop.preimpqc.final pop.write.qc.vcf eur $wd/eur_preimp_qc $wd/scripts
